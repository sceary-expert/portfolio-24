...
const Introduction = () => {
  return (
    <div className='flex flex-col justify-center h-screen d-[900px]' id='intro'>
        ...
        <div className=' font-[700] md:text-[70px] text-[40px] font-sans text-lightest_slate leading-[1.2] pb-3'>Dhananjoy Dey. <br/><span className='text-slate'>I build things for the web.</span></div>
